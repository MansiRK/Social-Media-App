...
export const updateProfileUser = ({userData, avatar, auth}) => async (dispatch) => {
    ...
    return dispatch({type: GLOBALTYPES.ALERT, payload: {error: "Your first name too long."}})

    if(!userData.lastname)
    return dispatch({type: GLOBALTYPES.ALERT, payload: {error: "Please add your last name."}})

    if(userData.lastname.length > 25)
    return dispatch({type: GLOBALTYPES.ALERT, payload: {error: "Your last name too long."}})
