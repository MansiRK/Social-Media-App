...
const Register = () => {
    ...
    const initialState = {
        fistname: '', lastname:'', username: '', email: '', password: '', cf_password: '', gender: 'male'
    }
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="register-group">
                            ...
                            <div className="register-group">
                                ...
                                <div className="pass">
                                    <input type={typePass ? "text" : lastname}
                            ...
                            <div className="register-group">
                                ...
                                <div className="pass">
                                    <input type="email"
                                        className="register-control" id="exampleInputEmail1" name="email"
                            ...
                            <div className="register-group">
                                ...
                                <div className="pass">
                                    ...
                                    <input type={typeCfPass ? "text" : "password"}
                                        ...
                                        style={{ background: `${alert.cf_password ? '#fff' : ''}` }} />
